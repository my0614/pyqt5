...
class Ui_first_page(QtWidgets.QWidget):
    ...
    def setupUi(self):
        ...
        self.textEdit.setGeometry(QtCore.QRect(170, 90, 301, 111))
        self.textEdit.setObjectName("textEdit")
        self.textEdit_2 = QtWidgets.QTextEdit(self)
        self.textEdit_2.setGeometry(QtCore.QRect(180, 260, 301, 111))
        self.textEdit_2.setObjectName("textEdit_2")
        self.pushButton = QtWidgets.QPushButton(self)
        self.pushButton.setGeometry(QtCore.QRect(210, 380, 231, 61))
        self.pushButton.setObjectName("pushButton")
        self.korean_2 = QtWidgets.QLabel(self)
        self.korean_2.setGeometry(QtCore.QRect(300, 210, 51, 41))
        self.korean_2.setStyleSheet("font: 11pt \"Agency FB\";")
        self.korean_2.setObjectName("korean_2")
        self.korean = QtWidgets.QLabel(self)
        self.korean.setGeometry(QtCore.QRect(300, 20, 51, 41))
